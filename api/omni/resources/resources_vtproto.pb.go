...
func (m *ListRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SearchFor) > 0 {
		for iNdEx := len(m.SearchFor) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.SearchFor[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
	...
	if len(m.SortByField) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SortByField)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Limit != 0 {
...
func (m *Event) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Old) > 0 {
		i -= len(m.Old)
		copy(dAtA[i:], m.Old)
		i = encodeVarint(dAtA, i, uint64(len(m.Old)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Resource) > 0 {
...
func (m *WatchResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SortFieldData) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SortFieldData)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Total != 0 {
