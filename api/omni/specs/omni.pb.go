...
var file_omni_specs_omni_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2a, 0x46, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x41, 0x70, 0x70, 0x6c,
...
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_omni_specs_omni_proto_goTypes = []interface{}{
	...
	(*MachineStatusSpec_HardwareStatus)(nil),                  // 73: specs.MachineStatusSpec.HardwareStatus
	(*MachineStatusSpec_NetworkStatus)(nil),                   // 74: specs.MachineStatusSpec.NetworkStatus
	(*MachineStatusSpec_PlatformMetadata)(nil),                // 75: specs.MachineStatusSpec.PlatformMetadata
	(*MachineStatusSpec_Schematic)(nil),                       // 76: specs.MachineStatusSpec.Schematic
	nil,                                                       // 77: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),        // 78: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),     // 79: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),      // 80: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil), // 81: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	(*ClusterSpec_Features)(nil),                              // 82: specs.ClusterSpec.Features
	(*MachineSetSpec_MachineClass)(nil),                       // 83: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_BootstrapSpec)(nil),                      // 84: specs.MachineSetSpec.BootstrapSpec
	(*ControlPlaneStatusSpec_Condition)(nil),                  // 85: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),                   // 86: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),              // 87: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),               // 88: specs.KubernetesStatusSpec.NodeStaticPods
	(*KubernetesUsageSpec_Quantity)(nil),                      // 89: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                           // 90: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),                // 91: specs.ImagePullRequestSpec.NodeImageList
	(*durationpb.Duration)(nil),                               // 92: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                             // 93: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),                        // 94: machine.MachineStatusEvent
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	73, // 0: specs.MachineStatusSpec.hardware:type_name -> specs.MachineStatusSpec.HardwareStatus
	74, // 1: specs.MachineStatusSpec.network:type_name -> specs.MachineStatusSpec.NetworkStatus
	3,  // 2: specs.MachineStatusSpec.role:type_name -> specs.MachineStatusSpec.Role
	75, // 3: specs.MachineStatusSpec.platform_metadata:type_name -> specs.MachineStatusSpec.PlatformMetadata
	77, // 4: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	76, // 5: specs.MachineStatusSpec.schematic:type_name -> specs.MachineStatusSpec.Schematic
	82, // 6: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	17, // 7: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	92, // 8: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	93, // 9: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	92, // 10: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	4,  // 11: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	93, // 12: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	93, // 13: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	93, // 14: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	...
	83, // 21: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	84, // 22: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	...
	83, // 26: specs.MachineSetStatusSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	94, // 27: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	85, // 28: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	86, // 29: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	88, // 30: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	...
	92, // 36: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	92, // 37: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	92, // 38: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	89, // 39: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	89, // 40: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	89, // 41: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	90, // 42: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	91, // 43: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	78, // 44: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	79, // 45: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	80, // 46: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	81, // 47: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	8,  // 48: specs.MachineSetSpec.MachineClass.allocation_type:type_name -> specs.MachineSetSpec.MachineClass.AllocationType
	2,  // 49: specs.ControlPlaneStatusSpec.Condition.type:type_name -> specs.ConditionType
	10, // 50: specs.ControlPlaneStatusSpec.Condition.status:type_name -> specs.ControlPlaneStatusSpec.Condition.Status
	11, // 51: specs.ControlPlaneStatusSpec.Condition.severity:type_name -> specs.ControlPlaneStatusSpec.Condition.Severity
	87, // 52: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
