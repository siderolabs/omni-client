...
var file_omni_specs_omni_proto_rawDesc = []byte{
	...
	0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x2f, 0x0a, 0x0d, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x74, 0x69, 0x63, 0x53, 0x70, 0x65, 0x63, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x74,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x65,
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2a, 0x46, 0x0a, 0x11, 0x43, 0x6f, 0x6e,
...
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 78)
var file_omni_specs_omni_proto_goTypes = []interface{}{
	...
	nil, // 76: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),        // 77: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),     // 78: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),      // 79: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil), // 80: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	(*ClusterSpec_Features)(nil),                              // 81: specs.ClusterSpec.Features
	(*MachineSetSpec_MachineClass)(nil),                       // 82: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_BootstrapSpec)(nil),                      // 83: specs.MachineSetSpec.BootstrapSpec
	(*ControlPlaneStatusSpec_Condition)(nil),                  // 84: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),                   // 85: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),              // 86: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),               // 87: specs.KubernetesStatusSpec.NodeStaticPods
	(*KubernetesUsageSpec_Quantity)(nil),                      // 88: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                           // 89: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),                // 90: specs.ImagePullRequestSpec.NodeImageList
	(*durationpb.Duration)(nil),                               // 91: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                             // 92: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),                        // 93: machine.MachineStatusEvent
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	...
	76, // 4: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	81, // 5: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	17, // 6: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	91, // 7: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	92, // 8: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	91, // 9: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	4,  // 10: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	92, // 11: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	92, // 12: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	92, // 13: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	...
	82, // 20: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	83, // 21: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	...
	82, // 25: specs.MachineSetStatusSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	93, // 26: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	84, // 27: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	85, // 28: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	87, // 29: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	...
	91, // 35: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	91, // 36: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	91, // 37: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	88, // 38: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	88, // 39: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	88, // 40: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	89, // 41: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	90, // 42: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	77, // 43: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	78, // 44: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	79, // 45: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	80, // 46: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	...
	86, // 51: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
