...
var file_omni_specs_omni_proto_depIdxs = []int32{
	...
	91, // 24: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	82, // 25: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	83, // 26: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	85, // 27: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	12, // 28: specs.KubernetesUpgradeStatusSpec.phase:type_name -> specs.KubernetesUpgradeStatusSpec.Phase
	49, // 29: specs.OngoingTaskSpec.talos_upgrade:type_name -> specs.TalosUpgradeStatusSpec
	57, // 30: specs.OngoingTaskSpec.kubernetes_upgrade:type_name -> specs.KubernetesUpgradeStatusSpec
	59, // 31: specs.OngoingTaskSpec.destroy:type_name -> specs.ClusterDestroyStatusSpec
	64, // 32: specs.FeaturesConfigSpec.etcd_backup_settings:type_name -> specs.EtcdBackupSettings
	89, // 33: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	89, // 34: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	89, // 35: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	86, // 36: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	86, // 37: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	86, // 38: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	87, // 39: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	88, // 40: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	76, // 41: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	77, // 42: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	78, // 43: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	79, // 44: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	8,  // 45: specs.MachineSetSpec.MachineClass.allocation_type:type_name -> specs.MachineSetSpec.MachineClass.AllocationType
	2,  // 46: specs.ControlPlaneStatusSpec.Condition.type:type_name -> specs.ConditionType
	10, // 47: specs.ControlPlaneStatusSpec.Condition.status:type_name -> specs.ControlPlaneStatusSpec.Condition.Status
	11, // 48: specs.ControlPlaneStatusSpec.Condition.severity:type_name -> specs.ControlPlaneStatusSpec.Condition.Severity
	84, // 49: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
