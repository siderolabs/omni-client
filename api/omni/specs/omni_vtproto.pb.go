...
func (m *EtcdBackupStatusSpec) CloneVT() *EtcdBackupStatusSpec {
	...
	r := &EtcdBackupStatusSpec{
		Status: m.Status,
		Error:  m.Error,
	}
	if rhs := m.LastBackupTime; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *timestamppb.Timestamp }); ok {
			r.LastBackupTime = vtpb.CloneVT()
		} else {
			r.LastBackupTime = proto.Clone(rhs).(*timestamppb.Timestamp)
		}
	}
	if rhs := m.LastBackupAttempt; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *timestamppb.Timestamp }); ok {
			r.LastBackupAttempt = vtpb.CloneVT()
		} else {
			r.LastBackupAttempt = proto.Clone(rhs).(*timestamppb.Timestamp)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *EtcdManualBackupSpec) CloneVT() *EtcdManualBackupSpec {
	...
	r := &EtcdManualBackupSpec{}
	if rhs := m.BackupAt; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *timestamppb.Timestamp }); ok {
			r.BackupAt = vtpb.CloneVT()
		} else {
			r.BackupAt = proto.Clone(rhs).(*timestamppb.Timestamp)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *MachineSetSpec_BootstrapSpec) CloneVT() *MachineSetSpec_BootstrapSpec {
	...
	r := &MachineSetSpec_BootstrapSpec{
		ClusterUuid: m.ClusterUuid,
		Snapshot:    m.Snapshot,
	}
	if len(m.unknownFields) > 0 {
...
func (m *KubernetesUsageSpec_Quantity) CloneVT() *KubernetesUsageSpec_Quantity {
	...
	r := &KubernetesUsageSpec_Quantity{
		Requests: m.Requests,
		Limits:   m.Limits,
		Capacity: m.Capacity,
	}
...
func (m *ImagePullRequestSpec_NodeImageList) CloneVT() *ImagePullRequestSpec_NodeImageList {
	...
	r := &ImagePullRequestSpec_NodeImageList{
		Node: m.Node,
	}
...
func (m *ImagePullStatusSpec) CloneVT() *ImagePullStatusSpec {
	...
	r := &ImagePullStatusSpec{
		LastProcessedNode:  m.LastProcessedNode,
		LastProcessedImage: m.LastProcessedImage,
		LastProcessedError: m.LastProcessedError,
...
func (this *EtcdBackupStatusSpec) EqualVT(that *EtcdBackupStatusSpec) bool {
	...
	if equal, ok := interface{}(this.LastBackupTime).(interface {
		EqualVT(*timestamppb.Timestamp) bool
	}); ok {
		if !equal.EqualVT(that.LastBackupTime) {
			return false
		}
	} else if !proto.Equal(this.LastBackupTime, that.LastBackupTime) {
		return false
	}
	if equal, ok := interface{}(this.LastBackupAttempt).(interface {
		EqualVT(*timestamppb.Timestamp) bool
	}); ok {
		if !equal.EqualVT(that.LastBackupAttempt) {
			return false
		}
	} else if !proto.Equal(this.LastBackupAttempt, that.LastBackupAttempt) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *EtcdManualBackupSpec) EqualVT(that *EtcdManualBackupSpec) bool {
	...
	if equal, ok := interface{}(this.BackupAt).(interface {
		EqualVT(*timestamppb.Timestamp) bool
	}); ok {
		if !equal.EqualVT(that.BackupAt) {
			return false
		}
	} else if !proto.Equal(this.BackupAt, that.BackupAt) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *EtcdBackupSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Snapshot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Snapshot)))
		i--
		dAtA[i] = 0x12
	}
	if m.CreatedAt != nil {
...
func (m *EtcdBackupStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastBackupAttempt != nil {
		if vtmsg, ok := interface{}(m.LastBackupAttempt).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.LastBackupAttempt)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
	...
	if m.LastBackupTime != nil {
		if vtmsg, ok := interface{}(m.LastBackupTime).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.LastBackupTime)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *EtcdManualBackupSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BackupAt != nil {
		if vtmsg, ok := interface{}(m.BackupAt).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.BackupAt)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *Machines) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Requested != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Requested))
		i--
		dAtA[i] = 0x20
	}
	if m.Connected != 0 {
...
func (m *MachineSetSpec_MachineClass) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.AllocationType != 0 {
		i = encodeVarint(dAtA, i, uint64(m.AllocationType))
		i--
		dAtA[i] = 0x18
	}
	if m.MachineCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.MachineCount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Name) > 0 {
...
func (m *KubernetesUsageSpec_Pod) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Capacity != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Capacity))
		i--
		dAtA[i] = 0x18
	}
	if m.Count != 0 {
...
func (m *ImagePullStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RequestVersion) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.RequestVersion)))
		i--
		dAtA[i] = 0x32
	}
	if m.TotalCount != 0 {
	...
	if m.ProcessedCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ProcessedCount))
		i--
		dAtA[i] = 0x20
	}
	if len(m.LastProcessedError) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.LastProcessedError)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.LastProcessedImage) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.LastProcessedImage)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.LastProcessedNode) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.LastProcessedNode)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *EtcdBackupStatusSpec) SizeVT() (n int) {
	...
	if m.LastBackupTime != nil {
		if size, ok := interface{}(m.LastBackupTime).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.LastBackupTime)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.LastBackupAttempt != nil {
		if size, ok := interface{}(m.LastBackupAttempt).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.LastBackupAttempt)
		}
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *EtcdManualBackupSpec) SizeVT() (n int) {
	...
	_ = l
	if m.BackupAt != nil {
		if size, ok := interface{}(m.BackupAt).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.BackupAt)
		}
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *MachineSetSpec_MachineClass) SizeVT() (n int) {
	...
	if m.MachineCount != 0 {
		n += 1 + sov(uint64(m.MachineCount))
	}
	if m.AllocationType != 0 {
		n += 1 + sov(uint64(m.AllocationType))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *ImagePullStatusSpec) SizeVT() (n int) {
	...
	if m.ProcessedCount != 0 {
		n += 1 + sov(uint64(m.ProcessedCount))
	}
	if m.TotalCount != 0 {
...
func (m *EtcdBackupStatusSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if unmarshal, ok := interface{}(m.LastBackupTime).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.LastBackupTime); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 4:
			...
			if unmarshal, ok := interface{}(m.LastBackupAttempt).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.LastBackupAttempt); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *EtcdManualBackupSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if unmarshal, ok := interface{}(m.BackupAt).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.BackupAt); err != nil {
					return err
				}
			}
			iNdEx = postIndex
