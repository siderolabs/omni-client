...
// InstallationMedia resource describes a Talos installation media that can be generated by the imager. It also describes the necessary parameters to be passed to the imager.
//
